...
export const createGatewayDiscountSchema = z.object({
    name: z.string()
    ...
    message: 'Max discount amount should only be set for percentage discounts',
...
export class CreateGatewayDiscountDto extends createZodDto(createGatewayDiscountSchema) {}

export class UpdateGatewayDiscountDto extends createZodDto(updateGatewayDiscountSchema) {}
