...
import { Save, Plus, Trash2, ArrowUp, ArrowDown, Layout, Image as ImageIcon, Type, ShoppingBag } from '@/lib/icons';
...
export default function PageBuilder() {
    return (
        <Suspense fallback={<div className="text-sm text-gray-400">Loading builder...</div>}>
            <PageBuilderContent />
        </Suspense>
    );
}
