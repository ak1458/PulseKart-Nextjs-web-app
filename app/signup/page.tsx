...
export default function SignupPage() {
  ...
  const handleSocialLogin = async (provider: 'google' | 'apple') => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setFormError(`${provider === 'google' ? 'Google' : 'Apple'} signup is currently unavailable.`);
      }
    } catch (error) {
      setFormError(`${provider === 'google' ? 'Google' : 'Apple'} signup failed.`);
    }
  };
  ...
  const features = [
    ...
    { icon: Pill, label: "Authentic Medicines" },
  ];
        ...
        <div className="relative z-10 flex flex-col justify-center px-16 xl:px-24 max-w-2xl">
          ...
          >
            ...
            <p className="text-gray-400 text-lg mb-10 max-w-md leading-relaxed">
              Create an account to access personalized health recommendations, 
              exclusive offers, and track your wellness goals.
            </p>
            ...
            <div className="grid grid-cols-3 gap-4">
              {features.map((feature, idx) => (
                <motion.div
                  ...
                  className="flex flex-col items-center gap-3 p-4 rounded-xl bg-white/[0.03] border border-white/10 text-center"
                >
      ...
      <div className="flex-1 flex items-center justify-center p-4 sm:p-6 lg:p-8 relative">
        ...
        >
          ...
          <div className="lg:hidden text-center mb-6">
            ...
            <p className="text-gray-500 text-sm">Join us for a healthier life</p>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  >
                    {showPassword ? <IconEyeOff className="w-4 h-4" /> : <Eye className="w-4 h-4" />}
                  </button>
                </div>
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute right-3.5 top-1/2 -translate-y-1/2 text-gray-500 hover:text-gray-300 transition-colors"
                  >
                    {showConfirmPassword ? <IconEyeOff className="w-4 h-4" /> : <Eye className="w-4 h-4" />}
                  </button>
                </div>
              </div>
              ...
              <label className="flex items-start gap-2 cursor-pointer">
                ...
                <span className="text-xs text-gray-400 leading-relaxed">
                  I agree to the{" "}
                  <Link href="/terms" className="text-teal-400 hover:text-teal-300">Terms</Link>{" "}
                  and{" "}
