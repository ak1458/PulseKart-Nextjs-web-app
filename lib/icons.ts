...
import {
    IconAdjustmentsHorizontal as TablerSlidersHorizontal,
    IconMoodSmile as TablerSmile,
    IconMoodSad as TablerFrown,
    IconMoodEmpty as TablerMeh,
    IconHeartbeat as TablerHeartPulse,
    ...
    IconBrandGoogle as TablerBrandGoogle,
    IconBrandApple as TablerBrandApple,
...
export const BrandGoogle = withDefaults(TablerBrandGoogle);
export const BrandApple = withDefaults(TablerBrandApple);
export const Globe = withDefaults(TablerGlobe);
export const Heart = withDefaults(TablerHeart);
export const HeartPulse = withDefaults(TablerHeartPulse);
export const SlidersHorizontal = withDefaults(TablerSlidersHorizontal);
export const Smile = withDefaults(TablerSmile);
export const Frown = withDefaults(TablerFrown);
export const Meh = withDefaults(TablerMeh);
